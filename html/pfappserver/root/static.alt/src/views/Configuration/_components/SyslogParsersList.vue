    ...
    >
      ...
      <template slot="buttons" slot-scope="item">
        <span class="float-right text-nowrap">
          ...
          <pf-button-delete  v-if="!item.not_deletable" size="sm" variant="outline-danger" :disabled="isLoading" :confirm="$t('Delete Syslog Parser?')" @on-delete="remove(item)" reverse/>
        </span>
      </template>
