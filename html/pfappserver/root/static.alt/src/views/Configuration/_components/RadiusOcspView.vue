  ...
  >
    <template v-slot:header>
      ...
      <h4 class="d-inline mb-0">
        <span v-if="!isNew && !isClone" v-html="$t('OCSP Configuration')"></span>
        <span v-else-if="isClone" v-html="$t('Clone OCSP Configuration')"></span>
        <span v-else>{{ $t('New OCSP Configuration') }}</span>
      </h4>
    </template>
