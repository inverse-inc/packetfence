...
import {
  pfConfigurationNetworkViewFields as fields
} from '@/globals/configuration/pfConfigurationNetwork'
...
export default {
  ...
  methods: {
    ...
    save () {
      ...
      this.$store.dispatch('$_bases/updateNetwork', form).then(response => {
        // TODO - notification
      })
    }
  },
