...
import {
  pfConfigurationAdvancedViewFields as fields
} from '@/globals/configuration/pfConfigurationAdvanced'
...
export default {
  ...
  methods: {
    ...
    save () {
      ...
      this.$store.dispatch('$_bases/updateAdvanced', form).then(response => {
        // TODO - notification
      })
    }
  },
