  ...
  <b-card no-body>
    ...
    >
      ...
      <template slot="buttonAdd">
        <b-button variant="outline-primary" :to="{ name: 'newFingerbankDhcpVendor' }">{{ $t('Add Local DHCP Vendor') }}</b-button>
      </template>
...
export default {
  ...
  methods: {
    clone (item) {
      this.$router.push({ name: 'cloneFingerbankDhcpVendor', params: { id: item.id } })
    },
    remove (item) {
