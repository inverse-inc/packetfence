  ...
  >
    <template v-slot:header>
      ...
      <h4 class="d-inline mb-0">
        <span v-if="!isNew && !isClone" v-html="$t('Fast Configuration')"></span>
        <span v-else-if="isClone" v-html="$t('Clone Fast Configuration')"></span>
        <span v-else>{{ $t('New Fast Configuration') }}</span>
      </h4>
    </template>
