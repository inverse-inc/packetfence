<template>
  ...
  >
    ...
    <form-group-account-sid namespace="account_sid"
      :column-label="$i18n.t('Account SID')"
      :text="$i18n.t('Twilio Account SID.')"
    />

    <form-group-auth-token namespace="auth_token"
      :column-label="$i18n.t('Auth Token')"
      :text="$i18n.t('Twilio Auth Token.')"
    />

    <form-group-twilio-phone-number namespace="twilio_phone_number"
      :column-label="$i18n.t('Phone Number (From)')"
