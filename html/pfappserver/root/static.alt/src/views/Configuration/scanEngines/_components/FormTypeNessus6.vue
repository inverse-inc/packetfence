<template>
  ...
  >
    ...
    <form-group-scanner-name namespace="scannername"
      :column-label="$i18n.t('Nessus scanner name')"
    ...
    <form-group-duration namespaces="duration"
