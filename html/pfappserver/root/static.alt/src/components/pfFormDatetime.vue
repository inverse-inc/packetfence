<template>
  <b-form-group horizontal :label-cols="labelCols" :label="$t(label)"
...
<style lang="scss">
/**
 * vue-bootstrap-datetimepicker only supports fontawesome,
 * define the icon content directly as base64 encodeda
 */
.icon-datetime {
  opacity:0.25;
