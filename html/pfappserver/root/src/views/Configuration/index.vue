  ...
  const sections = computed(() => ([
    ...
    },
    {
      ...
      items: [
        ...
        { name: this.$i18n.t('Multi-Factor Authentication'), path: '/configuration/mfas' }
      ]
    },
    {
      ...
      items: [
        ...
        { name: i18n.t('RADIUS'),
          items: [
            ...
            { name: i18n.t('SSL Certificates'), path: '/configuration/radius/ssl' },
        ...
        { name: i18n.t('Tenants'), path: '/configuration/tenants' }
      ]
    }
  ]))
