  ...
  <b-card no-body>
    <b-card-header>
      <h4 class="d-flex align-items-center">
        {{ $t('Provisioning') }}
        <base-button-help class="text-black-50 ml-1" url="PacketFence_Installation_Guide.html#provision" />
      </h4>
    </b-card-header>
    <div class="card-body">
      <base-search :use-search="useSearch">
        <b-dropdown :text="$t('New Provisioner')" variant="outline-primary">
          <b-dropdown-item v-for="({ text, value }) in provisioningTypeOptions" :key="value"
            :to="{ name: 'newProvisioning', params: { provisioningType: value } }"
...
import { provisioningTypeOptions } from '../config'
