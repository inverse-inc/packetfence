...
export const schema = (props) => {
  ...
  return yup.object({
    ...
    body: yup.string().nullable().label(i18n.t('Body')),
    broadcast: yup.string().nullable(),
    ca_cert_path: yup.string().nullable().required(i18n.t('Certificate required.')),
    ca_file: yup.string().nullable().label(i18n.t('CA certificate')),
    ...
    content_type: yup.string().nullable().label(i18n.t('Content-Type')),
    ...
    headers: yup.string().nullable().label(i18n.t('Headers')),
    host: yup.string().nullable().label(i18n.t('Host')),
    ios_agent_download_uri: yup.string().nullable().label(i18n.t('URI')),
    jq_query: yup.string().nullable().required(i18n.t('JQ query required.')).label(i18n.t('JQ query')),
    ...
    method: yup.string().nullable().label(i18n.t('Method')),
    ...
    timeout: yup.string().nullable().label(i18n.t('Timeout')),
    url: yup.string().nullable().required(i18n.t('URL required.')).label('URL'),
    user: yup.string().nullable().label(i18n.t('User')),
    username: yup.string().nullable().label(i18n.t('Username')),
    verify_ssl: yup.string().nullable(),
