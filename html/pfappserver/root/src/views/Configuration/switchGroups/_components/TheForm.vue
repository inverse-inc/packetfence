  ...
  >
    <b-tabs lazy>
      ...
      <base-form-tab :title="$i18n.t('Definition')" active>
        ...
        <form-group-voip-dacl namespace="VoIPDACL"
                              :column-label="$i18n.t('Send ACLs for VoIP')"
      ...
      <base-form-tab :title="$i18n.t('Roles')">
        ...
        <div
          v-if="!advancedMode && !supports(['RadiusDynamicVlanAssignment', 'RoleBasedEnforcement', 'VPNRoleBasedEnforcement', 'AccessListBasedEnforcement', 'ExternalPortal'])"
              ...
              <div class="card-body pb-0">
                ...
                <template v-if="isVlanMap">
                  <base-role-map-list :roles="filteredRoles" v-slot="{ role }">
                    <form-group-role-map-vlan :key="`${role}Vlan`"
                                              :namespace="`${role}Vlan`"
                                              :column-label="role"
                    />
                  </base-role-map-list>
            ...
            <b-card class="mb-3 pb-0" no-body>
              ...
              <div class="card-body pb-0">
                <template v-if="isInterfaceMap">
                  <base-role-map-list :roles="filteredRoles" v-slot="{ role }">
                    <form-group-role-map-interface :key="`${role}Interface`"
      ...
      <base-form-tab :title="$i18n.t('RADIUS')"
                     v-if="supports(['WiredMacAuth', 'WiredDot1x', 'WirelessMacAuth', 'WirelessDot1x', 'VPN'])">
          ...
          <div class="card-body pb-0">
            ...
            >
                    ...
                    <b-col cols="12" md="auto">
                      ...
                      <b-media v-else>
                        ...
                        <p class="font-weight-light">
                          {{ $t('Click the button below to add a new member.') }}</p>
                      </b-media>
                    </b-col>
                  </b-row>
                </b-container>
              ...
              <template v-slot:cell(id)="{ item, value }">
                <b-button variant="link" :to="{ name: 'switch', params: { id: item.id } }">{{
                    value
                  }}
                </b-button>
              </template>
...
import BaseRoleMapList from '../../switches/_components/BaseRoleMapList.vue'
