...
export const useRouter = $router => {
  return {
    ...
    goToItem: (params, props) => {
      ...
      $router
        .push({ name: 'fingerbankDhcpFingerprint', params: { ...params, scope: scope.value } })
        .catch(e => { if (e.name !== "NavigationDuplicated") throw e })
    },
    goToClone: params => $router.push({ name: 'cloneFingerbankDhcpFingerprint', params: { ...params, scope: 'local' } })
  }
}
