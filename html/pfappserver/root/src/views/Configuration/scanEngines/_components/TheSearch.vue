  ...
  <b-card no-body>
    <b-card-header>
      <h4 class="d-flex align-items-center mb-0">
        {{ $t('Scan Engines') }}
        <base-button-help class="text-black-50 ml-1" url="PacketFence_Installation_Guide.html#_scanner_definition" />
      </h4>
    </b-card-header>
    <div class="card-body">
      <base-search :use-search="useSearch">
        <b-dropdown :text="$t('New Scan Engine')" variant="outline-primary">
          <b-dropdown-item v-for="(text, scanType) in types" :key="scanType"
            :to="{ name: 'newScanEngine', params: { scanType } }"
