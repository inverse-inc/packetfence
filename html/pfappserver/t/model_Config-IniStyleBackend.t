...
model_Config-IniStyleBackend.t

=head1 DESCRIPTION

Unit testing for pfappserver::Model::Config::IniStyleBackend
...
BEGIN { use_ok 'pfappserver::Model::Config::IniStyleBackend' }
...
my $config = pfappserver::Model::Config::IniStyleBackend->new( config_file => 't/data/networks.conf' );
my $conf_ref = $config->_load_conf();
...
is_deeply($conf_ref, $expected_conf_ref, 'validating the configuration parser');
