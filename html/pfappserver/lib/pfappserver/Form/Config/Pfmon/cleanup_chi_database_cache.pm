...
sub default_batch {
    return $ConfigPfmonDefault{cleanup_chi_database_cache}{batch};
};
...
sub default_timeout {
    return $ConfigPfmonDefault{cleanup_chi_database_cache}{timeout};
};
...
sub default_interval {
    return $ConfigPfmonDefault{cleanup_chi_database_cache}{interval};
}
...
sub default_enabled {
    return $ConfigPfmonDefault{cleanup_chi_database_cache}{enabled};
}
