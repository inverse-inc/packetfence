package pfappserver::Form::Config::Pfcron::dns_audit_log_cleanup;

=head1 NAME

pfappserver::Form::Config::Pfcron::dns_audit_log_cleanup - Web form for dns_audit_log_cleanup pfcron task

=head1 DESCRIPTION

Web form for dns_audit_log_cleanup pfcron task
