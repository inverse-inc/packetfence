package pfappserver::Form::Config::Pfcron::security_event_purge;

=head1 NAME

pfappserver::Form::Config::Pfcron::security_event_purge - Web form for security_event_purge pfcron task

=head1 DESCRIPTION

Web form for security_event_purge pfcron task
