package pfappserver::Form::Config::Pfcron::pki_revoked_certs_cleanup;

=head1 NAME

pfappserver::Form::Config::Pfcron::pki_revoked_certs_cleanup - Web form for pki_revoked_certs_cleanup pfcron task

=head1 DESCRIPTION

Web form for pki_revoked_certs_cleanup pfcron task
...
sub default_type {
    return "pki_revoked_certs_cleanup";
}
