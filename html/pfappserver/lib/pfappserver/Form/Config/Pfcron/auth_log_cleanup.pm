package pfappserver::Form::Config::Pfcron::auth_log_cleanup;

=head1 NAME

pfappserver::Form::Config::Pfcron::auth_log_cleanup - Web form for auth_log_cleanup pfcron task

=head1 DESCRIPTION

Web form for auth_log_cleanup pfcron task
