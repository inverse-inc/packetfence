package pfappserver::Form::Config::Pfcron::security_events_cleanup;

=head1 NAME

pfappserver::Form::Config::Pfcron::security_events_cleanup - Web form for security_events_cleanup pfcron task

=head1 DESCRIPTION

Web form for security_events_cleanup pfcron task
...
sub default_type {
    return "security_events_cleanup";
}
