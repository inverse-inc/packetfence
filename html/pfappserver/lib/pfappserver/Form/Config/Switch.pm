...
has_block definition =>
  (
   render_list => [ qw(description type mode group deauthMethod cliAccess VoIPEnabled VoIPLLDPDetect VoIPCDPDetect uplink_dynamic uplink controllerIp controllerPort portalURL) ],
  );
