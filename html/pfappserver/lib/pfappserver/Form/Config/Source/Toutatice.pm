package pfappserver::Form::Config::Source::Toutatice;

=head1 NAME

pfappserver::Form::Config::Source::Toutatice - Web form for a Toutatice user source

=head1 DESCRIPTION

Form definition to create or update a Toutatice user source.
...
use pf::Authentication::Source::ToutaticeSource;
