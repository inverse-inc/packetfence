package pfappserver::Form::Config::FilterEngines::ProvisioningFilter::windows;

=head1 NAME

pfappserver::Form::Config::FilterEngines::ProvisioningFilter::windows -
...
use pf::constants::filters qw(@BASE_FIELDS @NODE_INFO_FIELDS @FINGERBANK_FIELDS @SWITCH_FIELDS @OWNER_FIELDS @SECURITY_EVENT_FIELDS @WINDOWS_FIELDS);
