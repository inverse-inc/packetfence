package pfappserver::Form::Config::FilterEngines::ProvisioningFilter::dpsk;

=head1 NAME

pfappserver::Form::Config::FilterEngines::ProvisioningFilter::dpsk -
...
use pf::constants::filters qw(@BASE_FIELDS @NODE_INFO_FIELDS @FINGERBANK_FIELDS @SWITCH_FIELDS @OWNER_FIELDS @SECURITY_EVENT_FIELDS @DPSK_FIELDS);
