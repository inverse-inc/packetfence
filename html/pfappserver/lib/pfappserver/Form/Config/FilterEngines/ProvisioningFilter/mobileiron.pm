package pfappserver::Form::Config::FilterEngines::ProvisioningFilter::mobileiron;

=head1 NAME

pfappserver::Form::Config::FilterEngines::ProvisioningFilter::mobileiron -
...
use pf::constants::filters qw(@BASE_FIELDS @NODE_INFO_FIELDS @FINGERBANK_FIELDS @SWITCH_FIELDS @OWNER_FIELDS @SECURITY_EVENT_FIELDS @MOBILEIRON_FIELDS);
