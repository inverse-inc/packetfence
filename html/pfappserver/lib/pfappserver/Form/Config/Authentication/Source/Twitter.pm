package pfappserver::Form::Config::Authentication::Source::Twitter;
...
has_field 'create_local_account' => (
    ...
    default => pf::Authentication::Source::TwitterSource->meta->get_attribute('create_local_account')->default,
    tags => {
        after_element => \&help,
