package pfappserver::Form::Config::Authentication::Source::Pinterest;

=head1 NAME

pfappserver::Form::Config::Authentication::Source::Pinterest - Web form for a Pinterest user source
...
has_field 'create_local_account' => (
    ...
    default => pf::Authentication::Source::PinterestSource->meta->get_attribute('create_local_account')->default,
    tags => {
        after_element => \&help,
