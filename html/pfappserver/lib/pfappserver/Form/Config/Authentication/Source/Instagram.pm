package pfappserver::Form::Config::Authentication::Source::Instagram;

=head1 NAME

pfappserver::Form::Config::Authentication::Source::Instagram - Web form for a Instagram user source
