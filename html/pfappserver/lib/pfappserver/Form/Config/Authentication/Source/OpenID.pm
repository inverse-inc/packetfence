package pfappserver::Form::Config::Authentication::Source::OpenID;
...
has_field 'create_local_account' => (
    ...
    default => pf::Authentication::Source::OpenIDSource->meta->get_attribute('create_local_account')->default,
    tags => {
        after_element => \&help,
