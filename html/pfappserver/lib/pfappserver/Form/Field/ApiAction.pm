...
sub options_api_method {
    my ($self) = @_;
    return {value => '', label => '--- choose ---'}, map {/^pf::api::(.*)$/;{value => $1, label => $1, sibling => {api_parameters => { placeholder => $pf::api::attributes::ALLOWED_ACTIONS{$_}}}} } sort keys %pf::api::attributes::ALLOWED_ACTIONS;
