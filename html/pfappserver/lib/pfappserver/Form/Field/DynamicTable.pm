...
sub add_delete {
    my ($self) = @_;
    return ' <div class="btn-group"><a class="btn-icon" href="#delete"><i class="icon-minus-sign"></i></a><a class="btn-icon" href="#add"><i class="icon-plus-sign"></i></a></div>';
}
