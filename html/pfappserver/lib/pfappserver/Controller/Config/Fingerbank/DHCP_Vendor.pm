...
pfappserver::Controller::Config::Fingerbank::DHCP_Vendor - Catalyst Controller
...
__PACKAGE__->config(
    action => {
        ...
        object => { Chained => '/', PathPart => 'config/fingerbank/dhcp_vendor', CaptureArgs => 1 },
    ...
    action_args => {
        ...
        '*' => { model => "Config::Fingerbank::DHCP_Vendor", form => "Config::Fingerbank::DHCP_Vendor" },
    },
);
