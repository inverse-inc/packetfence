...
__PACKAGE__->config(
    action => {
        ...
        object => { Chained => '/', PathPart => 'config/fingerbank/dhcp_fingerprint', CaptureArgs => 1 },
    ...
    action_args => {
        ...
        '*' => { model => "Config::Fingerbank::DHCP_Fingerprint", form => "Config::Fingerbank::DHCP_Fingerprint" },
    },
);
