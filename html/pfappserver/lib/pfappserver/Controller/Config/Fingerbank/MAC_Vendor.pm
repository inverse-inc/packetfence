...
pfappserver::Controller::Config::Fingerbank::MAC_Vendor - Catalyst Controller
...
__PACKAGE__->config(
    action => {
        ...
        object => { Chained => '/', PathPart => 'config/fingerbank/mac_vendor', CaptureArgs => 1 },
    ...
    action_args => {
        ...
        '*' => { model => "Config::Fingerbank::MAC_Vendor", form => "Config::Fingerbank::MAC_Vendor" },
    },
);
