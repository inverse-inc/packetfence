...
pfappserver::Controller::Config::Fingerbank::Combination - Catalyst Controller
...
__PACKAGE__->config(
    action => {
        ...
        object => { Chained => '/', PathPart => 'config/fingerbank/combination', CaptureArgs => 1 },
    ...
    action_args => {
        ...
        '*' => { model => "Config::Fingerbank::Combination", form => "Config::Fingerbank::Combination" },
    },
);
