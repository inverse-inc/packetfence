...
$remediation_header = 'Windows parches actualizados';
...
hacerlo esto resultará en un acceso a la red nuevamente sea deshabilitado. Repetidas fallas harán que el acceso sea perm
anentemente deshabilitado.";
