...
function print_status_table(){
  ...
  $ordered_service_list=array('httpd', 'pfdetect', 'pfdhcplistener', 'pfmon', 'pfredirect', 'line', 'named', 'dhcpd', 'pfsetvlan', 'snmptrapd', 'line', 'snort');
  ...
  print "<td>&nbsp;</td>\n";
  print "<td>&nbsp;</td>\n";
  print "<td align=center><a href=$current_top/$current_sub.php?service=pf&action=start><img src='images/start.png' title='Start All' border=0></a></td>\n";
