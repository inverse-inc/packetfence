...
$grammar = q {
   ...
   switchconfig_view_field : 'type' | 'mode' | 'uplink' | 'SNMPVersion' | 'SNMPCommunityRead' | 'SNMPCommunityWrite' | 'SNMPVersionTrap' | 'SNMPCommunityTrap' | 'cliTransport' | 'cliUser' | 'cliPwd' | 'cliEnablePwd'
