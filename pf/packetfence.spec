...
#2) rpmbuild --rebuild --define 'dist .el5' SRPMS/packetfence-1.8.3-20090604.src.rpm
Summary: PacketFence network registration / worm mitigation system
Name: packetfence
Version: 1.8.3
Release: 20090604%{?dist}
License: GPL
...
Source: http://prdownloads.sourceforge.net/packetfence/%{name}-%{version}-20090604.tar.gz
