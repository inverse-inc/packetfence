...
#2) rpmbuild --rebuild --define 'dist .el5' SRPMS/packetfence-1.8.4-20090617.src.rpm
...
%{__install} -d $RPM_BUILD_ROOT/usr/local/pf/var/rrd %{__install} -d $RPM_BUILD_ROOT/usr/local/pf/addons
