...
#2) rpmbuild --rebuild --define 'dist .el5' SRPMS/packetfence-1.8.2-20090330.src.rpm
Summary: PacketFence network registration / worm mitigation system
Name: packetfence
Version: 1.8.2
Release: 20090330%{?dist}
License: GPL
...
Source: http://prdownloads.sourceforge.net/packetfence/%{name}-%{version}-20090330.tar.gz
