...
#2) rpmbuild --rebuild --define 'dist .el5' SRPMS/packetfence-1.8.1-20090211.src.rpm
Summary: PacketFence network registration / worm mitigation system
Name: packetfence
Version: 1.8.1
Release: 20090211%{?dist}
License: GPL
...
Source: http://prdownloads.sourceforge.net/packetfence/%{name}-%{version}-20090211.tar.gz
