...
#2) rpmbuild --rebuild --define 'dist .el5' SRPMS/packetfence-1.8.1-20090210.src.rpm
Summary: PacketFence network registration / worm mitigation system
Name: packetfence
Version: 1.8.1
Release: 20090210%{?dist}
License: GPL
...
Requires: perl(CPAN)
Requires: perl(Time::HiRes), perl(Config::IniFiles), perl(Net::Netmask), perl(Date::Parse), perl(Parse::RecDescent), perl(Net::Pcap) >= 0.16, perl(CGI), perl(CGI::Session), perl(Term::ReadKey), perl(File::Tail), perl(Net::MAC::Vendor), perl(Net::SNMP), perl(LWP::UserAgent), perl(Net::Telnet), perl(Log::Log4perl) >= 1.11, perl(Thread::Pool), perl(Locale::gettext), perl(Template), perl(Apache::Htpasswd), perl(Net::MAC), perl(RRDs), perl(File::Spec)
