...
Requires: freeradius >= 3.2.5, freeradius-mysql >= 3.2.5, freeradius-perl >= 3.2.5, freeradius-ldap >= 3.2.5, freeradius-utils >= 3.2.5, freeradius-redis >= 3.2.5, freeradius-rest >= 3.2.5
Requires: make
Requires: net-tools
Requires: sscep
