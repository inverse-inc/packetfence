package pfconfig::namespaces::resource::connector_config;

=head1 NAME

pfconfig::namespaces::resource::connector_config
...
sub init {
    ...
    $self->{domains} = $self->{cache}->get_cache("config::DnsConnector");
