package pfconfig::namespaces::resource::interfaces;

=head1 NAME

pfconfig::namespaces::resource::interfaces
...
sub init {
    ...
    $self->{child_resources} = [
      'resource::interfaces::listen_ints',
      'resource::interfaces::dhcplistener_ints',
      'resource::interfaces::ha_ints',
      'resource::interfaces::internal_nets',
      'resource::interfaces::inline_enforcement_nets',
      'resource::interfaces::vlan_enforcement_nets',
      'resource::interfaces::monitor_int',
      'resource::interfaces::management_network',
    ];
}
