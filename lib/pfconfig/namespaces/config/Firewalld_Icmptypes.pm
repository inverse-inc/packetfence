package pfconfig::namespaces::config::Firewalld_Icmptypes;

=head1 NAME

pfconfig::namespaces::config::Firewalld_Icmptypes
...
This module creates the configuration hash associated to firewalld_icmptypes*.conf
