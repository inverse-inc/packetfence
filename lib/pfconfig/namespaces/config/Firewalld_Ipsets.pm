package pfconfig::namespaces::config::Firewalld_Ipsets;

=head1 NAME

pfconfig::namespaces::config::Firewalld_Ipsets
...
This module creates the configuration hash associated to firewalld_ipsets*.conf
