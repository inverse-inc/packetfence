...
$grammar = q {
   ...
   violationconfig_view_field : 'desc' | 'enabled' | 'auto_enable' | 'actions' | 'max_enable' | 'grace' | 'window' | 'vclose' | 'priority' | 'url' | 'button_text' | 'trigger' | 'vlan' | 'whitelisted_roles' | 'target_category'
