package pf::SNMP::Dlink::DGS_3100;

=head1 NAME

pf::SNMP::Dlink::DGS_3100 - Object oriented module to access SNMP enabled Dlink DES 3100 switches

=head1 SYNOPSIS

The pf::SNMP::Dlink::DGS_3100 module implements an object oriented interface
