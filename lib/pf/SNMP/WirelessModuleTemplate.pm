package pf::SNMP::WirelessModuleTemplate;

=head1 NAME

pf::SNMP::WirelessModuleTemplate

=head1 SYNOPSIS

The pf::SNMP::WirelessModuleTemplate module implements an object oriented interface to 
manage <HARDWARE>
