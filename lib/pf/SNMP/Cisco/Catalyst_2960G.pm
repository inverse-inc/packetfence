package pf::SNMP::Cisco::Catalyst_2960G;
=head1 NAME

pf::SNMP::Cisco::Catalyst_2960G
...
This module is currently only a placeholder, see L<pf::SNMP::Cisco::Cisco_2960> for relevant support items.
