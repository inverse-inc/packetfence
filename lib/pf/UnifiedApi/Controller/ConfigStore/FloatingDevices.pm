package pf::UnifiedApi::Controller::ConfigStore::FloatingDevices;

=head1 NAME

pf::UnifiedApi::Controller::ConfigStore::FloatingDevices - 
...
use Mojo::Base qw(pf::UnifiedApi::Controller::ConfigStore);
