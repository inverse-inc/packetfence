...
sub parseRequest {
    ...
    my $user_name       = $radius_request->{'AD-Samaccountname'} || $radius_request->{'TLS-Client-Cert-Subject-Alt-Name-Upn'} || $radius_request->{'TLS-Client-Cert-Common-Name'} || $radius_request->{'User-Name'};
