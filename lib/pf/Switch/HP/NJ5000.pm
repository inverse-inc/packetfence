...
pf::Switch::HP::NJ5000 module manages access to NJ5000
...
sub wiredeauthTechniques {
    ...
    if ($connection_type == $WIRED_802_1X) {
        ...
        my %tech = (
            $SNMP::SNMP => 'handleReAssignVlanTrapForWiredMacAuthe',
        );
