...
sub sources_domains {
    ...
    foreach my $source ( @authentication_sources ) {
        ...
        elsif ( ($classname eq 'pf::Authentication::Source::GoogleSource') || ($classname eq 'pf::Authentication::Source::GithubSource') || ($classname eq 'pf::Authentication::Source::FacebookSource') || ($classname eq 'pf::Authentication::Source::LinkedInSource') || ($classname eq 'pf::Authentication::Source::WindowsLiveSource') || ($classname eq 'pf::Authentication::Source::TwitterSource') || ($classname eq 'pf::Authentication::Source::InstagramSource') || ($classname eq 'pf::Authentication::Source::PrinterestSource')) {
            push(@domains, split(',',$source->{'domains'}));
