...
our (
    ...
    @inline_enforcement_nets, @vlan_enforcement_nets, $management_network, @dhcp_ints, @dns_ints, @additional_listen_interfaces,
...
BEGIN {
    ...
    @EXPORT_OK = qw(
        ...
        @inline_enforcement_nets @vlan_enforcement_nets @dhcp_ints @dns_ints @additional_listen_interfaces
