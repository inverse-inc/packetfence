...
BEGIN {
    ...
    @EXPORT = qw(
        ...
        $ROLE_API_LEVEL
        $SELFREG_MODE_EMAIL $SELFREG_MODE_SMS $SELFREG_MODE_SPONSOR $SELFREG_MODE_GOOGLE $SELFREG_MODE_FACEBOOK $SELFREG_MODE_GITHUB $SELFREG_MODE_LINKEDIN $SELFREG_MODE_LIVE $SELFREG_MODE_NULL
        %CAPTIVE_PORTAL
        $HTTP $HTTPS
...
Readonly our $SELFREG_MODE_LIVE   => 'live';
