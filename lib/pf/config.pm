...
our (
    ...
    @internal_nets, @routed_isolation_nets, @routed_registration_nets, @inline_nets, @portal_ints,@radius_ints, @additional_listen_interfaces,
...
BEGIN {
    ...
    @EXPORT_OK = qw(
        @listen_ints @dhcplistener_ints @ha_ints $monitor_int
        @internal_nets @routed_isolation_nets @routed_registration_nets @inline_nets $management_network @portal_ints @radius_ints @additional_listen_interfaces
...
tie @additional_listen_interfaces, 'pfconfig::cached_array', "resource::additional_listen_interfaces($host_id)";
