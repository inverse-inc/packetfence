...
our @EXPORT = qw(admin_can admin_can_do_any admin_can_do_any_in_group %ADMIN_ROLES admin_allowed_options admin_allowed_options_all check_allowed_unreg_date check_allowed_options admin_isdisabled_option);
our %ADMIN_ROLES;
...
our %ADMIN_GROUP_ACTIONS = (
    CONFIGURATION_GROUP_READ => [
        qw( CONFIGURATION_MAIN_READ CONNECTION_PROFILES_READ
          ...
          FINGERBANK_READ CLOUD_READ FIREWALL_SSO_READ REALM_READ SCAN_READ
          PKI_PROVIDER_READ WRIX_READ FILTERS_READ PORTAL_MODULE_READ
          SELF_SERVICE_READ MFA_READ
          )
      ],
    LOGIN_GROUP => [
        qw( SERVICES_READ REPORTS_READ USERS_READ NODES_READ CONFIGURATION_MAIN_READ
          ...
          FINGERBANK_READ CLOUD_READ FIREWALL_SSO_READ REALM_READ DOMAIN_READ SCAN_READ
          PKI_PROVIDER_READ WRIX_READ FILTERS_READ PORTAL_MODULE_READ
          USERS_READ_SPONSORED AUDITING_READ SELF_SERVICE_READ MFA_READ
          )
      ],
);
