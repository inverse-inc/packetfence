...
NOTE: While using webauth change the switch module for AeroHIVE AP_http.

image::docs/images/aerohive-pf-config-role-webauth.png[scaledwidth="100%",alt="Roles switch settings"]

image::docs/images/aerohive-pf-config-role-webauth2.png[scaledwidth="100%",alt="WebAuth URL switch settings"]
...
image::docs/images/aerohive-captive-portal.png[scaledwidth="100%",alt="Captive Web Portal configuration"]
