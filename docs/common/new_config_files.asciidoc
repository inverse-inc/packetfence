Once packages are all upgraded, you should take care to review any changes to
...
Compare them with your installed versions and see if there are changes that
should be merged into your existing configuration.
