...
PacketFence exposes an HTTP JSON API which exposes most of its functionality. 

The full API spec documentation for the latest stable release is available here: http://petstore.swagger.io/?url=https://raw.githubusercontent.com/inverse-inc/packetfence/stable/docs/api/spec/openapi.yaml 
