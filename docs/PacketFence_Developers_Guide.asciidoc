...
Install <<dev-prerequisites,development prerequisites>> and follow
<<dev-setup,initial setup>> but in place of starting `pfcen7dev`, you can
start:
...
To keep your machine up-to-date, you can run following commands:
...
If you want to use Ansible directly against Vagrant virtual machines, you can use following commands:
