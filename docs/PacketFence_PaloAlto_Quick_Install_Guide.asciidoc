PacketFence: PaloAlto firewall Quick Integration Guide
======================================================
:encoding: UTF-8
:lang: en
:doctype: book
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Now we have the key, we will configure the PaloAlto firewall in PacketFence.
...
Secret or Key: LUFRPT1jeFV6SHd1QnJHaU55dnYvRlFNSkJNeTR6Uzg9TDgzNVlj0= (Put the key previously generated)
Port: 443
