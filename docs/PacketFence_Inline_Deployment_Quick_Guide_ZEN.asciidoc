PacketFence Inline Deployment Quick Install Guide using ZEN
===========================================================
:encoding: UTF-8
:lang: en
:doctype: book
...
In this guide we will show you how to configure the INLINE (in-band) mode. If you want to configure the VLAN (out-of-band) mode please refer to the guide include::docs/PacketFence_Out-of-Band_Deployment_Quick_Install_Guide_ZEN.asciidoc[PacketFence Out of Band Deployment Quick Guide using ZEN].
...
If you have a routed network that need to be take into account by PacketFence as an Inline subnet, you will need to add this via `Routed Network` and select Inline L3. PacketFence will be the DHCP server for this routed network.
