...
Step 2: Verification
~~~~~~~~~~~~~~~~~~~~
For our example, when the user register on the portal it will be registered and the role staff will be assigned. The PacketFence server will send a request to the Barracuda database.
