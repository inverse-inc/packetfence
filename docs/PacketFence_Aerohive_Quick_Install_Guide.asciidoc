...
About this Guide
----------------
This guide has been created in order to provide guidelines to deploy a Aerohive Wireless APs and the associated management in a PacketFence context, whether it is with a standalone server, a cluster or PacketFence ZEN deployement.
...
However, the configuration is the same for the local and the Cloud-base controller.
...
In _Definition_ ::
* _IP Address/MAC Address/Range (CIDR)_, give the network address of your _Production_ network; For us, it will be *172.16.1.1/24*
...
WARNING: it's advanced configuration, you need to understand what you do.
...
Step 1 : A new SSID 
~~~~~~~~~~~~~~~~~~~
You should create a new SSID, has chown before, secured or opened, as you need, there is no particular point.


Step 2 : Set Filters in PacketFence
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
References and External Informations
-------------------------------------
