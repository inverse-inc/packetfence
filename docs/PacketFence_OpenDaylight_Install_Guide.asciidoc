...
If your network equipment supports reactive forwarding with OpenDaylight, then it can be used in parralel with PacketFence to handle the non-DNS traffic.
