...
image::wlc-9800-radius_server.jpeg[scaledwidth="100%",alt="Create AAA Radius Server"]

Click Server Groups, Click Add

image::wlc-9800-aaa-pf-group.jpeg[scaledwidth="100%",alt="Create AAA Radius Server Group"]

Go to Configuration > Security > AAA > AAA Method List > Authentication, Click Add

image::wlc-9800-aaa-method-list-authentication.jpeg[scaledwidth="100%",alt="AAA Authentication"]

Go to Configuration > Security > AAA > AAA Method List > Authorization, Click Add

image::wlc-9800-aaa-method-list-authorization.jpeg[scaledwidth="100%",alt="AAA Authorization"]

Go to Configuration > Security > AAA > AAA Method List > Accounting, Click Add

image::wlc-9800-aaa-method-list-accounting.jpeg[scaledwidth="100%",alt="AAA Accouting"]
...
image::wlc-9800-wlan-pf-open-general.jpeg[scaledwidth="100%",alt="Add PF-Open WLAN"]

image::wlc-9800-wlan-pf-open-security-l2.jpeg[scaledwidth="100%",alt="Add PF-Open WLAN"]

image::wlc-9800-wlan-pf-open-security-aaa.jpeg[scaledwidth="100%",alt="Add PF-Open WLAN"]

Create Policy Profiles PF-Open

Go to Configuration > Tags & Profiles > Policy, Click Add

image::wlc-9800-policy-pf-open-general.jpeg[scaledwidth="100%",alt="Add PF-Open Policy Profile"]

image::wlc-9800-policy-pf-open-access-pol.jpeg[scaledwidth="100%",alt="Add PF-Open Policy Profile"]

image::wlc-9800-policy-pf-open-advanced.jpeg[scaledwidth="100%",alt="Add PF-Open Policy Profile"]

Go to Configuration > Tags & Profiles > Tags, under Policy Click Add

image::wlc-9800-tag-pf-open.jpeg[scaledwidth="100%",alt="Add PF-Open Policy Tag"]
...
image::wlc-9800-ap-policy.jpeg[scaledwidth="100%",alt="Add PF Enabled Policy on the AP"]

====== PF-Secure SSID

Go to Configuration > Tags & Profiles > WLANs, Click Add

image::wlc-9800-wlan-pf-secure-general.jpeg[scaledwidth="100%",alt="Add PF-Secure WLAN"]

image::wlc-9800-wlan-pf-secure-security-l2-1.jpeg[scaledwidth="100%",alt="Add PF-Secure WLAN"]

image::wlc-9800-wlan-pf-secure-security-l2-2.jpeg[scaledwidth="100%",alt="Add PF-Secure WLAN"]

image::wlc-9800-wlan-pf-secure-security-aaa.jpeg[scaledwidth="100%",alt="Add PF-Secure WLAN"]

Create Policy Profiles PF-Secure

Go to Configuration > Tags & Profiles > Policy, Click Add

image::wlc-9800-policy-pf-secure-general.jpeg[scaledwidth="100%",alt="Add PF-Secure Policy Profile"]

image::wlc-9800-policy-pf-secure-access-pol.jpeg[scaledwidth="100%",alt="Add PF-Secure Policy Profile"]

image::wlc-9800-policy-pf-secure-advanced.jpeg[scaledwidth="100%",alt="Add PF-Secure Policy Profile"]

Go to Configuration > Tags & Profiles > Tags, under Policy Click Add

image::wlc-9800-tag-pf-secure.jpeg[scaledwidth="100%",alt="Add PF-Secure Policy Tag"]
...
image::wlc-9800-wlc-9800-acl-authorize_any.jpeg[scaledwidth="100%",alt="Authorize_any Access List"]
...
image::wlc-9800-acl-authorize_any.jpeg[scaledwidth="100%",alt="Pre-Auth-For-WebRedirect Access List"]

PF-WebAuth SSID creation

Go to Configuration > Tags & Profiles > WLANs, Click Add

image::wlc-9800-wlan-pf-webauth-general.jpeg[scaledwidth="100%",alt="Add PF-WebAuth WLAN"]

image::wlc-9800-wlan-pf-webauth-security-l2.jpeg[scaledwidth="100%",alt="Add PF-WebAuth WLAN"]

image::wlc-9800-wlan-pf-webauth-security-aaa.jpeg[scaledwidth="100%",alt="Add PF-WebAuth WLAN"]

Create Policy Profiles PF-WebAuth

Go to Configuration > Tags & Profiles > Policy, Click Add

image::wlc-9800-policy-pf-webauth-general.jpeg[scaledwidth="100%",alt="Add PF-WebAuth Policy Profile"]

image::wlc-9800-policy-pf-webauth-access-pol.jpeg[scaledwidth="100%",alt="Add PF-WebAuth Policy Profile"]

image::wlc-9800-policy-pf-webAuth-advanced.jpeg[scaledwidth="100%",alt="Add PF-WebAuth Policy Profile"]

Go to Configuration > Tags & Profiles > Tags, under Policy Click Add

image::wlc-9800-tag-pf-webauth.jpeg[scaledwidth="100%",alt="Add PF-Secure Policy Tag"]
...
image::wlc-9800-pf-switch-definition.jpeg[scaledwidth="100%",alt="PF Switch configuration"]

image::wlc-9800-pf-switch-roles-1.jpeg[scaledwidth="100%",alt="PF Switch Role configuration"]

image::wlc-9800-pf-switch-roles-2.jpeg[scaledwidth="100%",alt="PF Switch Role configuration"]
