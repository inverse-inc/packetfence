...
image::aruba-interface-redirection.png[scaledwidth="100%",alt="Interface de
redirection"]
...
image::aruba-secondary-controller.png[scaledwidth="100%",alt="Secondary
...
image::aruba-wlc-roles.png[scaledwidth="80%",alt="Aruba wireless controller
roles configuration"]
