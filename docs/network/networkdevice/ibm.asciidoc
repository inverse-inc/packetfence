...
PacketFence supports only 802.1X authentication. It has been tested on version
7.9.11.0.
...
To configure the IBM RackSwitch G8052 switch module, in the admin interface go
to *Configuration -> Network Devices -> Switches -> Add switch*
