...
Note: "Comware v5" module is developed for the H3C S5120 Series siwtches using Comware v5 and also this module inherits all its capabilities from the old "S5120" module.
