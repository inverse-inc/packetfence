...
#Note: "Procurve_2600" module is developed for the ProCurve 2600 Series switches using AOS Switch version 16.x and also this module inherits all its capabilities from the old "ProCurve 2600 S
eries" module.
...
Note: The "ArubaOS Switch 16.11" module is developed for the ProCurve 5400 Series switches using AOS Switch version 16.11 and also this module inherits all its capabilities from the old "ProCurve 5400 Series" module.
