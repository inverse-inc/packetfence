...
image::certificate/1-HTTP[scaledwidth="100%",alt="Prompt fields module"]
...
image::certificate/2-HTTP-Certificate[scaledwidth="100%",alt="Prompt fields module"]
4. Import or open your private key file (.key) and copy/paste the content into the "HTTP Server Private Key" field.
image::certificate/3-HTTP-Private-key[scaledwidth="100%",alt="Prompt fields module"]
5. Turn on the options "Find HTTPs intermediate CA(s) automatically" and "Validate certificate chain".
image::certificate/4-HTTP-intermediate-chain[scaledwidth="100%",alt="Prompt fields module"]
...
image::certificate/5-Services[scaledwidth="100%",alt="Prompt fields module"]
...
image::certificate/6-HTTP-View[scaledwidth="100%",alt="Prompt fields module"]
...
image::certificate/7-Radius-edit[scaledwidth="100%",alt="Prompt fields module"]
...
image::certificate/8-Radius-certificate[scaledwidth="100%",alt="Prompt fields module"]
...
image::certificate/9-Radius-key[scaledwidth="100%",alt="Prompt fields module"]
...
image::certificate/10-Radius-CA[scaledwidth="100%",alt="Prompt fields module"]

6. Turn on the "Find RADIUS Server intermediate CA(s) automatically" and "Validate certificate chain" option.
image::certificate/13-Radius-intermediate-chain[scaledwidth="100%",alt="Prompt fields module"]
...
image::certificate/11-Services[scaledwidth="100%",alt="Prompt fields module"]
...
image::certificate/12-Radius-status[scaledwidth="100%",alt="Prompt fields module"]
