...
Follow the three step wizard to create your certification authority, your client and server profile and your REST API configuration.
...
Note: Please be sure to change the default password to the PKI.
