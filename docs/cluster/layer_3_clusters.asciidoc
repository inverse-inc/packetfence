...
For db_master, you define which server will be use for all the write. Use only one single ip in this section since you can only do the write on a single server.
