...
In order to do so, <<PacketFence_Upgrade_Guide.asciidoc#automation_of_upgrades,apply the upgrade process described here>> **on node C only**.
...
in
<<PacketFence_Upgrade_Guide.asciidoc#restart_packetfence_services,Restart PacketFence services section>>.
...
Then, <<PacketFence_Upgrade_Guide.asciidoc#automation_of_upgrades,apply the upgrade process described here>> **on nodes A and B**.
...
provided in
<<PacketFence_Upgrade_Guide.asciidoc#restart_packetfence_services,Restart
