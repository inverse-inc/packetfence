...
In order to do so, https://www.packetfence.org/doc/PacketFence_Upgrade_Guide.html#automation_of_upgrades[apply the upgrade process described here] **on node C only**.
...
in
https://www.packetfence.org/doc/PacketFence_Upgrade_Guide.html#restart_packetfence_services[Restart PacketFence services section].
...
Then, https://www.packetfence.org/doc/PacketFence_Upgrade_Guide.html#automation_of_upgrades[apply the upgrade process described here] **on nodes A and B**.
...
provided in
https://www.packetfence.org/doc/PacketFence_Upgrade_Guide.html#restart_packetfence_services[Restart
