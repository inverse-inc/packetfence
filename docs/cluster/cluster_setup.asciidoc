...
Please refer to <<../PacketFence_Installation_Guide.asciidoc#_domain_joining_on_a_packetfence_cluster_v14_x, Domain joining on a PacketFence cluster v14.x>> for detailed steps.
