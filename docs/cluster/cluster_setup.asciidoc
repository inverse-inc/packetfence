...
https://www.packetfence.org/doc/PacketFence_Installation_Guide.html#installation[PacketFence
Installation Guide>>.
...
Please refer to https://www.packetfence.org/doc/PacketFence_Installation_Guide.html#domain_joining_on_a_packetfence_cluster_v14_x[Domain joining on a PacketFence cluster v14.x] for detailed steps.
