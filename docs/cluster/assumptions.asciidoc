 ...
 * PacketFence does support exteral MySQL primary/replicas to allow deployments which are geo distributed (see 'Geo Distributed Database' in this document for details)
