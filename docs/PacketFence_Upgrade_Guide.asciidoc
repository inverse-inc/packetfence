...
When a LDAP condition is added in the LDAP authentication source a LDAP search is done to retrieve the values.
...
the following provisionners will be removed from Packetfence configuration ibm, servicenow, sepm, symantec, opswat
