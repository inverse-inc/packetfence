...
2. **Follow automation**: Use <<PacketFence_Upgrade_Guide.asciidoc#_automation_of_upgrades,automation of upgrades>>
...
2. **Follow cluster guide**: See <<PacketFence_Clustering_Guide.asciidoc#_performing_an_upgrade_on_a_cluster,Performing an upgrade on a cluster>>
...
3. **Review limitations**: Read <<PacketFence_Installation_Guide.asciidoc#_assumptions_and_limitations,assumptions and limitations>>
...
2. **Begin export**: Follow <<PacketFence_Installation_Guide.asciidoc#_export_on_current_installation,export process>>
...
Follow instructions: <<PacketFence_Upgrade_Guide.asciidoc#_automation_of_upgrades,automation of upgrades>>
...
1. Use the automated upgrade process: <<PacketFence_Upgrade_Guide.asciidoc#_sequential_version_upgrades_major_and_minor,Sequential Version Upgrades (major or minor)>>
...
If mariadb-backup is not installed, follow the standard export process at <<PacketFence_Installation_Guide.asciidoc#_export_on_current_installation,export on current installation>>.

**Prerequisites**: Read <<PacketFence_Installation_Guide.asciidoc#_assumptions_and_limitations,assumptions and limitations>> before proceeding.
...
Follow the automated upgrade: <<PacketFence_Upgrade_Guide.asciidoc#_automation_of_upgrades,automation of upgrades>>
