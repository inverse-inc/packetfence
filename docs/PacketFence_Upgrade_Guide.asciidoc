...
Due to OS (from Debian 11 to Debian 12) and mariadb upgrades on PacketFence 14.x, upgrading to Packetfence version 14.1 is mandatory before upgrading to 15.0.
