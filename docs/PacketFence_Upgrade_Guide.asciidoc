...
===== On Debian 11 from PacketFence version 11.1 to 13.2
...
Import the backup on the new host using the <<PacketFence_Installation_Guide.asciidoc#_import_on_new_installation,Import on new installation>> procedure.


===== On RedHat EL8 from PacketFence version 11.1 to 13.2
