...
=== MariaDB Specific Upgrades

Some PacketFence **requires specific upgrade steps** because MariaDB must be
upgraded through major versions. Each PacketFence version is tested with
specific Minor MariaDB versions (like 10.11.x).
