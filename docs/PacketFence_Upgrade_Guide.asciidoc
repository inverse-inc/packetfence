...
To use PacketFence 14.0 on Debian 12, a new Debian 12 VM will need to be created, then <<PacketFence_Installation_Guide.html#_exportimport_mechanism,import/export>> from the previous installation to the new one.
