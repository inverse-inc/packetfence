...
If you are not using it, please just follow the default export process explained there <<PacketFence_Installation_Guide.html#_export_on_current_installation>>. 
