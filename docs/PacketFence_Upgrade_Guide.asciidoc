...
1. Use the automated upgrade process: <<PacketFence_Upgrade_Guide.asciidoc#_upgrade_to_another_version_major_or_minor,Upgrade to another version (major or minor)>>
...
Follow the automated upgrade: <<PacketFence_Upgrade_Guide.asciidoc#_full_upgrade_for_packetfence_versions_11_1_0_and_later,Full upgrade>>

=== EL8 Cluster Upgrade 

**Cluster-specific procedure** - Follow the cluster upgrade guide: <<PacketFence_Upgrade_Guide.asciidoc#_performing_an_upgrade_on_a_cluster,Performing an upgrade on a cluster>>
