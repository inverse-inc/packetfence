...
==== Export DB with mariadb-backup installed to PacketFence 14.0.0 on Debian 12

===== From PacketFence version 11.1.0 to 13.2.0
...
* On debian11 with mariadb-backup installed
...
* on el8 with MariaDB-backup installed
----
yum -y remove MariaDB-backup
yum -y localinstall https://archive.mariadb.org/mariadb-10.11.6/yum/rhel8-amd64/rpms/MariaDB-backup-10.11.6-1.el8.x86_64.rpm
----
...
----
yum -y remove MariaDB-backup
yum -y install MariaDB-backup --enablerepo=packetfence
----
