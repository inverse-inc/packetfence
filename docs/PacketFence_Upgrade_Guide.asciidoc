...
After package upgrades have been performed, you can move file to its original location:
...
Configuration will be move to [filename]`/usr/local/pf/conf/pfcron.conf` file during configuration migration step.
