...
Also, add the following Authorized domains : *.google.com,*.google.ca,*.google.fr,*.gstatic.com,googleapis.com,accounts.youtube.com (Make sure that the the google from your country like Canada => *.google.ca, France => *.google.fr, etc...)
