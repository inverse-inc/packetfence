...
Windows Live
^^^^^^^^^^^^
To use Windows live, you also need an API code and a secret key.  To get one, you need to create an App here: https://apps.twitter.com/.  When you create your App, make sure you specify the following as the Callback URL
