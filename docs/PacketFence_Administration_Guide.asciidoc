...
* Redirect URL under *Configuration -> Connection Profile -> Profile Name*
...
* Filters under *Configuration -> Connection Profile -> Profile Name -> Filters*
...
* Advanced filter under *Configuration -> Connection Profile -> Profile Name -> Advanced Filter*
...
Go in Configuration -> Connection Profiles -> Edit a Profile -> Add Scan
