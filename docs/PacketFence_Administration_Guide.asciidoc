...
In the administation inferface, go in 'Advanced Configuration -> Fencing'. Activate 'Passthrough' and make sure the following passthrough are present:
...
IP icon-exchange MAC - Perform automatic translation of IPs to MACs and the other way around
