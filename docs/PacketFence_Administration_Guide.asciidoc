...
You must also enable the passthrough option in your PacketFence configuration (fencing.passthrough in pf.conf).
...
These parameters should be configured from the *Configuration -> Advanced Portal Configuration -> Access Duration* section of the Web admin interface.
