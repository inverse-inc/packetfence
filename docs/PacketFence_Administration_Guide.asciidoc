...
A configuration of a new pfdetect parser as well as some violations are the only remaining steps to make full usage of the Security Onion IDS integration.
