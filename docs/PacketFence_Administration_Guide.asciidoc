...
This SSO (Single Sin-On) feature is a way to match the Policies of your firewalls after a valid authentication on the captive portal. You can apply policies based on PacketFence's roles (categories). We actualy support two ways to inform the firewall, Accounting request and XML request. 
...
Activate the Accounting Listenning:
+++++++++++++++++++++++++++++++++++
