...
In order to do that, in the administration interface, go in 'Portal Configuration -> Provisioners'. Then select the 'android' provisioner. Enter the SSID and save.
