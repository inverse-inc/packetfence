...
PacketFence supports the ability to manage guest by establishing expire dates and assign a different role which will permit a different access to the network resources.
