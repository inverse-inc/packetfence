...
Go in the Administration interface under *Configuration -> Policies and Access Control -> Domains -> Microsoft Active Directory Domains*.
...
<<<<<<< afecf7c43938dc70e540c185c340f24cc132d24f
...
>>>>>>> No more allusion to net.ipv4.ip_forward in the Admin guide since it is activated at package installation.
