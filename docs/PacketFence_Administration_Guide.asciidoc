...
PacketFence is able to update some firewall based on device informations, like the IP address, the username connected on it. (Look for Integration guides to see how you can configure your Firewall with PacketFence)
