...
Twitter
^^^^^^^
To use Twitter, you also need an API code and a secret key which Twitter calls consumer key and consumer secret.  To get these, you need to create an App here: https://apps.twitter.com/.  When you create your App, make sure you specify the following as the Callback URL
