...
In order to use the PacketFence repository :
  ...
  # rpm -Uvh http://packetfence.org/downloads/PacketFence/RHEL6/`uname -i`/RPMS/packetfence-release-1.0-0.20140428_1.el6.x86_64.rpm
...
Refer to Network Devices Configuration Guide to see a sample web auth configuration on a Cisco WLC.
