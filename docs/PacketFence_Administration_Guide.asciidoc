...
Some public captive portal provides the capability of allowing a guest/user to register using his Google or Facebook account.  We can also do that in PacketFence.
...
field : https://o2.packetfence.org/o2/google
...
Once you have your client id, and API key, you need to configure the OAuth2 provider in pf.conf.  The example below shows you how to do it:
   ...
   redirect_uri = https://o2.packetfence.org/o2/google

Also, enable the Google authentication in the guests_self_registration.modes field.

Facebook
^^^^^^^^
To use Facebook, you also need an API code and a secret key.  To get one, go here: https://developers.facebook.com/apps.  When you create your App, make sure you input https://o2.packetfence.org/o2/facebook 
for the Site URL.
...
Once you have your information, configure the OAuth2 provider in pf.conf that way:
   ...
   redirect_uri = https://o2.packetfence.org/o2/facebook
