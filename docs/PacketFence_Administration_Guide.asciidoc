...
It's possible to get a specific portal profile based on filters. Actually in Packetfence you have the following filters: Connection Type, Network, Node Role, Port, realm, SSID, Switch, Switch Port, URI and VLAN.

Example with the most common one:

* SSID: Guest-SSID
* VLAN: 100

CAUTION: Node role will take effect only with a 802.1x connection and if you use vlan_filters.
