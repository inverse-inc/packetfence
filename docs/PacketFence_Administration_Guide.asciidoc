...
The CSV must look like: "description, IP or MAC, switch group". If an entry with one provided IP/MAC already exist it will not be added. You MUST create switches group before.
