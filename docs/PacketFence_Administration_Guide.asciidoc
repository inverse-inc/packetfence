...
Then go in 'Configuration -> Portal Modules' and click 'Add Portal Module' and select 'Authentication -> Null'

Configure the module with the 'Mandatory fields' you want and uncheck 'Require AUP' so that the user doesn't have to accept the AUP before submitting these fields.

### screenshot prompt_fields module
...
### screenshot hello world in my first root module
