...
Pinterest
^^^^^^^^^
To use Pinterest, you also need an API code and a secret key.  To get one, go here: https://developers.pinterest.com/apps.  When you create your App, make sure you specify the following as the Redirect URLs:
https://YOUR_PORTAL_HOSTNAME/oauth2/callback
