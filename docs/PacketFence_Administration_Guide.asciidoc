...
NOTE: Under Debian, the freeradius server is a dependency of PacketFence, so
you don't have to install it. Just be careful, the configuration directory is
under `/etc/freeradius`.
