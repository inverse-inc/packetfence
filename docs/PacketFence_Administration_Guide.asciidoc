...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Problem: Internet Explorer 8-10 will probably raise "Internet Explorer cannot display the webpage" errors when attempting to access PacketFence admin interface. 

Troubleshoot: 

 * Verify that PacketFence admininstation interface is started:
...
* TLSv1.2 needs to be activated for PacketFence admin interface to be accessible. It is advised that you update your browser. If not possible: 
