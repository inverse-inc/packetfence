...
The idea now is to create the request and private key from the PacketFence server. Connect to PacketFence via ssh and type the following in the CLI to generate the private key:
