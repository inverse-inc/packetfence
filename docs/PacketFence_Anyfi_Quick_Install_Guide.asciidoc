PacketFence: Anyfi Quick Installation Guide
============================================
:encoding: UTF-8
:lang: en
:doctype: book
    ...
    service {
        anyfi {
            gateway ma-gw {
                ...
                bridge br0
                controller <IP of the Anyfi controller>
                isolation
                nas {
                    identifier anyfi
                    port 3799
...
N.B. : The Anyfi gateway currently doesn't support VLAN assignation when using WPA2 enterprise. Devices connecting to this network will gain access to the native VLAN of eth1.
