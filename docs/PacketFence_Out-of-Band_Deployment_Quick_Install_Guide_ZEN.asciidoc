...
NOTE: Ignore the High-Availability options for now. If you are interested in a PacketFence cluster, please refer to the include::includes/PacketFence_Clustering_Guide.asciidoc[]
