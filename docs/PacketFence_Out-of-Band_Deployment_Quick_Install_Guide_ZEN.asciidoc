...
In the last section, Local Database Passwords, you will have to chose the password encryption for local accounts (guest automaticaly generated and manualy created account) 
