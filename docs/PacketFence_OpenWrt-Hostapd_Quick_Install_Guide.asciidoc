...
Introduction
------------
This guide will provide an example for the configuration of an open SSID (not encrypted) and a secured SSID (802.1x). You will to install wpad and hostapd. These two SSIDs will do RADIUS authentication against PacketFence.
