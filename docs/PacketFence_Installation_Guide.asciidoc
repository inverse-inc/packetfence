...
If you send IP address of nodes in accounting data and want to update iplog entries of your nodes, you can enabled 'Update the iplog using the accounting' setting in 'System configuration -> Main configuration -> Advanced'.
