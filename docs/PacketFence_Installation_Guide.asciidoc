...
.EXAMPLE: revent a device from connecting when its role is "default", the SSID is "SECURE", the current time is between 11am and 2pm, from Monday to Friday and as a registered device
[source,ini,numbered]
----
  [category]
...
----
  ...
  action_param = mac = $mac, tid = SOMETHING_HAPPENED, type = CUSTOM
----
