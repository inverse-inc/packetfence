...
By default a switch has a SNMPv3 engineID, you can get it with `show snmp engineid`

Test from a PacketFence server
++++++++++++++++++++++++++++++

With `net-snmp` package, you can test SNMPv3 communication with your switch:
