...
On the PacketFence side edit the file /etc/sysconfig/network-scripts/ifcfg-gre1
...
On the other side edit the file /etc/sysconfig/network-scripts/ifcfg-gre1
...
And this file too edit the file /etc/sysconfig/network-scripts/route-gre1
