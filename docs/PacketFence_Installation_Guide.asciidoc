 ...
 * When specifying multiple periods that are comma delimited, you will need to double up the commas. Example: `wd {1 3 5 7} min {0-29}, wd {2 4 6} min {30-59}` becomes `wd {1 3 5 7} min {0-29},, wd {2 4 6} min {30-59}`
