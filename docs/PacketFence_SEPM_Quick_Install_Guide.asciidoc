PacketFence: Symantec Endpoint Protection Manager Quick Integration Guide
=========================================================================
:encoding: UTF-8
:lang: en
:doctype: book
...
N.B. The next steps use 192.168.1.100 as the SEPM address. Adapt the URLs to your own SEPM address. 
...
----
ex : https://192.168.1.100:8446/sepm/oauth/authorize?
     response_type=code&client_id=1234567890-0987654321-1234567890
...
----
ex : https://172.21.2.186:8446/sepm/oauth/token?
     grant_type=authorization_code&client_id=1234567890-0987654321-1234567890
     &client_secret=0987654321-1234567890-0987654321
     &redirect_uri=http://localhost/&code=x5tHH8
----
...
----
ex : {"access_token":"4e3ab3ab-7b1e-4d24-9f5e-c347599a8a72","token_type":"bearer",
...
In order to enable the boarding passthrough for the device enrollment, you will need to restart PacketFence.

You can do this using the command line by doing 'service packetfence restart' or in the administration interface under 'Status / Services'.
...
After you install the client click continue. If your access is enabled than this means the connectivity between PacketFence and the Symantec Endpoint Protection Manager is good.
