...
Once powered, open a browser and point it to the configuration URL as stated by the VM login prompt (ie. http://PF_IP:3000/configurator). The configuration process is a five steps process at the end of which, the VM will be a persistent working PacketFence environment.
