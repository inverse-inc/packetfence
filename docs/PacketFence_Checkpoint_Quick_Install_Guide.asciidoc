...
image::docs/images/doc-checkpoint-accounting_settings.png[scaledwidth="100%",alt="Accouting settings"]

1. In the Check Point Gateway window > Identity Awareness pane, click Settings (to the right of the RADIUS Accounting option).
...
image::docs/images/doc-checkpoint-SSO_Role.png[scaledwidth="100%",alt="Configure the Checkpoint SSO in PacketFence"]
