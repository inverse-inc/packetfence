...
Previous versions used Azure Active Directory Graph which is now deprecated and will stop working after December 2022, if you have granted those permissions you can remove them and add the Microsoft Graph Application.Read.All one instead.
