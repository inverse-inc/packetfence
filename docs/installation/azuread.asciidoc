...
. In the admin interface, go to _Configuration -> Policies and Access Control -> Authentication Sources_, and create a new 'Azure Active Directory' internal source
...
. In the admin interface, go to _Configuration -> Policies and Access Control -> Realms_, and create a new realm
