...
install the Nessus package for your operating system. You will also need to
...
callback so you'll want to make sure that you have "portal" in your additionnal
listening daemons on your management interface in PacketFence.
 ...
 ** In the URL above, only change PF_MANAGEMENT_IP to the management IP of your
