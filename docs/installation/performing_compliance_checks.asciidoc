...
NOTE: You may run into some issue while using Nessus with the Net::Nessus::XMLRPC module (which is the default behavior in PacketFence). Please refer to the https://packetfence.org/bugs/view.php?id=1841[bug tracking system] for more information.
