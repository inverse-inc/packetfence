...
If you enabled Percona XtraBackup or Mariabackup for your nightly backup, you
can use the following instructions to restore it. In this example we will be
restoring
...
Once done, you should have a lot of files that were extracted in the restore
dir. Now, lets place the xbstream back in the backup directory
...
Starting from PacketFence 11.0, you can use <<#_exportimport_mechanism,the
