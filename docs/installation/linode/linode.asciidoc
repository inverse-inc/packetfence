...
NOTE:  The pfconnector is currently in the ‘Technical Preview’ phase. It can safely be used in production but has not yet been field proven for large scale and/or complex deployments
 ...
 * RADIUS MAB
 * RADIUS 802.1x
 * Captive portal through web-auth (no registration or isolation VLAN support)
