...
<<PacketFence_Clustering_Guide.asciidoc#_cluster_setup,PacketFence
...
----
echo "deb [signed-by=/etc/apt/keyrings/packetfence.gpg] https://inverse.ca/downloads/PacketFence/debian/{release_minor} bookworm bookworm" > \
