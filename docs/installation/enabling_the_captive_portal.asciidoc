...
If the captive portal doesn't appear or redirects fail, check portal-related logs as described in <<#_log_files,Log Files>> and <<#_network_connectivity_issues,Network Connectivity Issues>> in the Troubleshooting section.
