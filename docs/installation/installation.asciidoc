...
----
yum localinstall http://packetfence.org/downloads/PacketFence/RHEL7/packetfence-release-{release_minor}-el7.noarch.rpm
----
...
[source,bash,subs="attributes"]
----
echo 'deb http://inverse.ca/downloads/PacketFence/debian/{release_minor} stretch stretch' > \
