...
To do so, login to the PacketFence web administration interface if it is not already done. Click on the Configuration tab and select the switches section under Policies and Access Control.
