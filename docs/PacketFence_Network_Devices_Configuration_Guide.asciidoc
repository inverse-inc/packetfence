...
In order to enable VoIP, you first need to enable LLDP then defined the network policy for tagging VoIP traffic on the ports where PacketFence is enabled.
