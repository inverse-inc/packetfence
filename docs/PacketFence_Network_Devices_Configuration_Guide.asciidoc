...
image::docs/images/aruba-webauth-radius.png[scaledwidth="100%",alt="RADIUS server"]
  ...
  Host: Management adress of PacketFence
  Auth Port: 1812
  Acct Port: 1813
  Key: RADIUS secret
...
Next you will need to create the policy that will redirect user to the PacketFence captive-portal while not authenticated.
