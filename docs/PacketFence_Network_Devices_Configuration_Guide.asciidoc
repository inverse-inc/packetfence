...
The HP 1910 Serie is based on the 3Com OS and most of the configuration will be done in the GUI.
...
image::docs/images/hp1910_00.png[scaledwidth="100%",alt="VLANs Creation"]
...
image::docs/images/hp1910_01.png[scaledwidth="100%",alt="RADIUS configuration"]
...
image::docs/images/hp1910_01.png[scaledwidth="100%",alt="Shared key Configuration"]
...
image::docs/images/hp1910_01.png[scaledwidth="100%",alt="AAA Domain Creation"]
...
image::docs/images/hp1910_01.png[scaledwidth="100%",alt="802.1X and EAP"]
...
* Change the _YOUR_DOMAIN_NAME_ with the one from your context.
* Do not close your terminal, we will come back to this later.

* On the GUI, go to *Authentication*, *802.1X*,
...
image::docs/images/hp1910_01.png[scaledwidth="100%",alt="802.1X Authentication"]
...
* Modify the interface name for your context.

Congratulation, the configuration is done::
