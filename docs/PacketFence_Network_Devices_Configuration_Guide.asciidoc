...
PacketFence supports only the 802.1x. It's tested and developped for the Firmware 7.9.11.0.
...
radius-server primary-host 192.168.1.5 key useStrongerSecret
----
...
In order to configure the IBM RackSwitch G8052 switch module, go on the PacketFence admin web page under *Configuration->Switches->Add switch*
