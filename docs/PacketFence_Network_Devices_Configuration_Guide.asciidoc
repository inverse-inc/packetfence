...
Device sensor is a way to be able to receive some informations about the device in the radius accounting packet.
(Like DHCP, CDP, LLDP, HTTP informations)
In order to enable Device Sensor feature, you need to add the following parameters.
...
This configuration will send send informations about DHCP, LLDP, CDP of the device threw the accounting packet.
...
Device sensor is a way to be able to receive some informations about the device in the radius accounting packet.
(Like DHCP, HTTP informations)
In order to enable Device Sensor feature, you need to enable the following parameters.
