...
image::docs/images/cambium-dot1x-radius.png[scaledwidth="100%",alt="Cambium WLAN Radius"]
...
image::docs/images/cambium-mac-auth.png[scaledwidth="100%",alt="Cambium MAC Authentication"]
...
image::docs/images/cambium-web-auth.png[scaledwidth="100%",alt="Cambium Web Authentication"]

image::docs/images/cambium-web-auth-whitelist.png[scaledwidth="100%",alt="Cambium Web Authentication Whitelist"]
...
image::docs/images/cambium-role-web-auth.png[scaledwidth="100%",alt="Cambium Role for Web Authentication"]
