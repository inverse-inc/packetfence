...
When your configuration is ready on the Meraki side, add the switch in PacketFence, select the module "Meraki cloud controller v2". Make sure to have RADIUS as the deauthentification method. To work in webAuth, you need to select "Role by Web Auth URL" in the tab "Roles". 

Refer to Cisco WebAuth section to see how to configure it.
