...
First of all you will need to configure a RADIUS server.

image::docs/images/aruba-webauth-radius.png[scaledwidth="100%",alt="RADIUS server"]
...
image::docs/images/aruba-webauth-radius-coa.png[scaledwidth="100%",alt="RADIUS CoA server"]
...
Now create the policy for the guest acess, for instance internet only.
