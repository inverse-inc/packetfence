...
Next, you will need to create the policy that will redirect users to the PacketFence captive portal when they are not authenticated. Go to `Security -> Authentication -> L3 Authenticaion -> Captive Portal Authentication Profile`.
...
image::docs/images/aruba-wlc1.png[scaledwidth="100%",alt="Add Aruba wireless controller"]
image::docs/images/aruba-wlc-roles.png[scaledwidth="100%",alt="Aruba wireless controller roles configuration"]
