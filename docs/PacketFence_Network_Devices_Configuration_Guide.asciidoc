...
radius-server template packetfence
 ...
 radius-server authentication 172.20.20.109 1812
 radius-server accounting 172.20.20.109 1813
 radius-server retransmit 2
radius-server authorization 172.20.20.109 shared-key cipher <yourSecret>
