...
PacketFence supports the Netgear M series in wired 802.1X and MAC authentication bypass without VoIP.
On the PacketFence side you need to disable EAP MD5 support (Configuration -> System config -> Authentication Methods)
...
On your interfaces for 802.1x with MAC Authentication
+++++++++++++++++++++++++++++++++++++++++++++++++++++
