SentineOne Quick Integration Guide
==================================
:encoding: UTF-8
:lang: en
:doctype: book
...
* 'Mac OSX agent download URI' is the URI on which the users should download the MAC OSX agent. If you followed the path in this guide, it should be `/common/SentinelOne.pkg`.
...
After you install the client click continue. If your access is enabled than this means the connectivity between PacketFence and SentinelOne is good.
