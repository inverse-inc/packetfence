...
Click Install the hostapd package, the actual version is 2015-03-25-1.
...
In order to apply this configuration, when you are connected using SSH on the AP, run the command 'wifi'. It will reload the configuration and broadcast the SSID. If you want to bug, you can use the command 'logread'.
