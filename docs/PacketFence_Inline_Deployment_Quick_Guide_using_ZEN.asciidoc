PacketFence Inline Deployement Quick Install Guide ZEN
========================
:encoding: UTF-8
:lang: en
:doctype: book
...
In this guide we will show you how to configure the INLINE (in-band) mode. If you want to configure the VLAN (out-of-band) mode please refer to the guide includes::docs/PacketFence_Out-of-Band_Deployment_Quick_Install_Guide_ZEN.asciidoc[PacketFence Out of Band Deployment Quick Guide using ZEN].
...
If you got a Succes! message for this all three sections, click Continue.
...
In the last section, Local Database Passwords, you will have to chose the password encryption for local accounts (guest autmaticaly generated and manualy created account).
...
----
Now you can plug any devices that you want to be in the inline network in any of the port you just setup.
