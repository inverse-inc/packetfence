...
NOTE: Isolation is omitted in this example for brievety and should be configured the same way as registration if needed)
...
image::docs/images/cluster-zones-registration.png[scaledwidth="100%",alt="Cluster zones with registration network"]
