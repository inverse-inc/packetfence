...
Cluster::
  <<#_cluster_setup,Cluster Setup>>, <<#_troubleshooting_a_cluster,Troubleshooting a Cluster>>

Database::
  <<#_understanding_the_galera_cluster_synchronization,Understanding the Galera Cluster Synchronization>>

Failover::
  <<#_advanced_configuration,Advanced Configuration>>, <<#_troubleshooting_a_cluster,Troubleshooting a Cluster>>

Galera::
  <<#_understanding_the_galera_cluster_synchronization,Understanding the Galera Cluster Synchronization>>

HA::
  <<#_cluster_setup,Cluster Setup>>, <<#_advanced_configuration,Advanced Configuration>>

HAProxy::
  <<#_advanced_configuration,Advanced Configuration>>, <<#_layer_3_clusters,Layer 3 Clusters>>

IP::
  <<#_cluster_setup,Cluster Setup>>, <<#_layer_3_clusters,Layer 3 Clusters>>
...
Network::
  <<#_layer_3_clusters,Layer 3 Clusters>>

Node::
  <<#_cluster_setup,Cluster Setup>>, <<#_maintenance_and_operations,Maintenance and Operations>>
