...
In registration and isolation networks, DHCP and DNS servers are physical IP addresses of *all* cluster members.


Clients SNMP
^^^^^^^^^^^^

If you use SNMP in a cluster environment, you will need to allow physical IP addresses of **all** cluster members to query your network devices.
