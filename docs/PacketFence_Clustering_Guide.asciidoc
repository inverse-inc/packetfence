...
If no error is found in the previous configuration, the previuous restart of packetfence  should have started two additionnal services : haproxy and keepalived
