...
image::docs/images/billingtier_hourly.png[scaledwidth="100%",alt="Billing Tier example hourly"]
image::docs/images/billingtier_daily.png[scaledwidth="100%",alt="Billing Tier example daily"]
