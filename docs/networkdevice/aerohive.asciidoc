...
Create a SSID to add the Captive Portal fonction:
[options="compact"]
...
* once the _<RADIUS Settings>_ appaers under the captive portal, click on it
* on that new windows _Choose RADIUS_ click New
