...
To test PacketFence on several distributions, we used Vagrant virtual machines.
You can set up
...
* pywinrm > 0.3 if you want to use `ad` virtual machine
* Ansible = 2.10.X
...
packetfence_install__centos_packages:
  - packetfence-9.2-20191126180126.98740132.0007.el7
EOF
