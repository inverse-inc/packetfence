...
https://www.packetfence.org/doc/PacketFence_Upgrade_Guide.html#stop_all_packetfence_services[Stop all
...
First, ensure you have taken backups of your data. We highly encourage you to perform snapshots of all the virtual machines prior to the upgrade. You should also take a backup of the database and the `/usr/local/pf` directory using https://www.packetfence.org/doc/PacketFence_Upgrade_Guide.html#database_and_configurations_backup[database and configurations backup instructions]
...
https://www.packetfence.org/doc/PacketFence_Upgrade_Guide.html#packages_upgrades[Packages upgrades
section>>.
...
Now, ensure you follow the directives in the https://www.packetfence.org/doc/PacketFence_Upgrade_Guide.html[upgrade guide] as you would on a standalone server **including** the database schema updates.
