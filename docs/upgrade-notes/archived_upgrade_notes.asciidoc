...
<<#_stop_all_packetfence_services,Stop all PacketFence services section>>.
...
<<#_upgrade_packages,Packages upgrades section>>.
...
<<PacketFence_Upgrade_Guide.asciidoc#_automation_of_upgrades,automation of upgrades>>.
...
<<PacketFence_Installation_Guide.asciidoc#_eap_local_user_authentication,EAP local user authentication>>).
