...
modified. Simply update the file /usr/local/pf/conf/currently-at to match the
new
release number.
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-4.0-4.1.0.sql
...
/usr/local/pf/conf/currently-at to match the new release number.
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-4.1-4.2.0.sql
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-4.2-4.3.0.sql
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-4.3-4.4.0.sql
...
Once completed, update the file /usr/local/pf/conf/currently-at to match the new
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-4.4-4.5.0.sql
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-4.5-4.6.0.sql
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-4.6-4.7.0.sql
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-4.7-5.0.0.sql
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-5.0-5.1.0.sql
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-5.1-5.2.0.sql
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-5.2-5.3.0.sql
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-5.3-5.4.0.sql
...
configuration and change them in /usr/local/pf/lib/pf/StatsD.pm
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-5.4-5.5.0.sql
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-5.5-5.6.0.sql
...
If you have defined any filters in /usr/local/pf/conf/vlan_filters.conf, ensure
...
line in the default section of `/usr/local/pf/conf/switches.conf`
...
Make sure you run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-5.6-5.7.0.sql
...
violation in `/usr/local/pf/conf/violations.conf`
...
When ready, run the following to update your schema:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-5.7-6.0.0.sql
...
To upgrade the database schema, run the following command: 
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-6.0-6.1.0.sql
...
RADIUS secret defined in /usr/local/pf/conf/local_secret. Make sure you
...
To upgrade the database schema, run the following command: 
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-6.1-6.2.0.sql
...
The following file: /usr/local/pf/conf/radiusd/eap.conf was modified to use
TemplateToolkit, you will need to replace it by
/usr/local/pf/conf/radiusd/eap.conf.example, ensure to re-edit the new file and
...
script should be run `# /usr/local/pf/addons/upgrade/to-6.3-os-rewrite.pl` to
...
To upgrade the database schema, run the following command: 
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-6.3-6.4.0.sql
...
To upgrade the database schema, run the following command: 
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-6.4-6.5.0.sql
...
The email templates have been moved from /usr/local/pf/conf/emails/ to
/usr/local/pf/html/captive-portal/templates/emails/ as they are now configurable
...
To upgrade the database schema, run the following command:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-6.5-7.0.0.sql
...
To upgrade the database schema, run the following command:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-7.0-7.1.0.sql
...
Templates
/usr/local/pf/html/pfappserver/root/authentication/source/type/ ->
...
To upgrade the database schema, run the following command:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-7.1-7.2.0.sql
...
To upgrade the database schema, run the following command:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-7.2-7.3.0.sql
...
To upgrade the database schema, run the following command:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-7.3-7.4.0.sql
...
To upgrade the database schema, run the following command:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-7.4-8.0.0.sql
...
To upgrade the database schema, run the following command:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-8.0-8.1.0.sql
...
To upgrade the database schema, run the following command:
 ...
 mysql -u root -p pf -v < /usr/local/pf/db/upgrade-8.1-8.2.0.sql
...
To upgrade the database schema, run the following command:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-8.2-8.3.0.sql
...
To upgrade the database schema, run the following command:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-8.3-9.0.0.sql
...
To upgrade the database schema, run the following command:
  ...
  mysql -u root -p pf -v < /usr/local/pf/db/upgrade-9.0-9.1.0.sql
...
[source,bash]
----
mysql -u root -p pf -v < /usr/local/pf/db/upgrade-9.1-9.2.0.sql
----
...
[source,bash]
----
mysql -u root -p pf -v < /usr/local/pf/db/upgrade-9.2-9.3.0.sql
----
...
[source,bash]
----
mysql -u root -p pf -v < /usr/local/pf/db/upgrade-9.3-10.0.0.sql
----
...
[source,bash]
----
mysql -u root -p pf -v < /usr/local/pf/db/upgrade-10.0-10.1.0.sql
----
...
[source,bash]
----
mysql -u root -p pf -v < /usr/local/pf/db/upgrade-10.1-10.2.0.sql
----
...
[source,bash]
----
mysql -u root -p pf -v < /usr/local/pf/db/upgrade-10.2-10.3.0.sql
----
