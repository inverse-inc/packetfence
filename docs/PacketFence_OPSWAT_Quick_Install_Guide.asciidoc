...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
First of all you will need to create a cloud account at OPSWAT and configure the basic functionality of OPSWAT using their documentation.

Step 2: Developer account
~~~~~~~~~~~~~~~~~~~~~~~~~
Now that you have basic functionality for your OPSWAT account, you will need to create a developper account so PacketFence can access the OPSWAT API. You can do this here https://gears.opswat.com/developers.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
From your OPSWAT console, click '+Devices' at the top. Then click on Enable 'GEARS client on another device'. At the bottom you will see the URL to install the agent. Keep that URL in order to configure it in PacketFence
