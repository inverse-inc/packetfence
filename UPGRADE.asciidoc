...
^^^^^^^^^^^^^^^^^^^^^^^^^
You must rename "PORTAL_PROFILE" to "CONNECTION_PROFILE" in your adminroles.conf configuration file and reload the configuration after. You can automate this using:
