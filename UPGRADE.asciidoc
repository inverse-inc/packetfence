...
All the OAuth2 sources you have configured (Facebook, Github, Google, LinkedIn and Twitter) need to be adjusted as the redirect URL is now the same for all the types.
