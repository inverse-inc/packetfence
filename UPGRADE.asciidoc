...
Please refer to the PacketFence Clustering Guide available at 'https://github.com/inverse-inc/packetfence/blob/stable/docs/PacketFence_Clustering_Guide.asciidoc', more specifically the "Perform an upgrade on a cluser" section 'https://github.com/inverse-inc/packetfence/blob/stable/docs/PacketFence_Clustering_Guide.asciidoc#performing-an-upgrade-on-a-cluster'
