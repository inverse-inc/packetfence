...
Before starting the upgrade shut down monitoring to prevent alerts from generating false-positives. To see if monit is installed and running issue a monit summary.
