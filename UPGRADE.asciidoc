...
In this version we need to have the kernel-devel package that match your current kernel version in order to build the netflow kernel module.

Before doing the upgrade you have 2 choices:
