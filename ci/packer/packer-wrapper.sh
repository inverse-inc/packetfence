...
configure_and_check() {
    ...
    declare -p ANSIBLE_FORCE_COLOR
    declare -p ANSIBLE_EL_GROUP ANSIBLE_DEBIAN_GROUP ANSIBLE_RUBYGEMS_GROUP
    ...
    export ANSIBLE_EL_GROUP ANSIBLE_DEBIAN_GROUP ANSIBLE_RUBYGEMS_GROUP
}
