...
configure_and_check() {
    ...
    RESULT_DIR=${RESULT_DIR:-/var/local/gitlab-runner/vagrant_img/${CI_PIPELINE_ID}-${BAKE_ARCH}}
    BOX_NAME="${PF_VM_NAME}"
...
# Package only this job's converted volume. Shared base boxes stay cached.
package_box() {
