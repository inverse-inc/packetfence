...
is(pf::Switch::NEC::QX_S->new->supportsWiredMacAuth, 1, "pf::Switch::NEC::QX_S supportsWiredMacAuth still works");
is(pf::Switch::NEC::QX_S->new->supportsWiredDot1x, 1, "pf::Switch::NEC::QX_S supportsWiredDot1x still works");
