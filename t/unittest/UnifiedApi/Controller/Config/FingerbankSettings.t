...
unit test for FingerbankSettings
...
my $collection_base_url = '/api/v1/config/fingerbank_settings';

my $base_url = '/api/v1/config/fingerbank_setting';

$t->patch_ok(
    "$base_url/upstream" => json => {
