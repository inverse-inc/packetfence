...
my $results = $filter->evalActionParams("key1 = val1, key2 = \$var2, key4 = \${var3.var-4}", {var2 => 'val2', var3 => { 'var-4' => 'val4' }}, "test eval of parameters");

is_deeply($results, [key1 => 'val1', 'key2' => 'val2', key4 => 'val4']);
