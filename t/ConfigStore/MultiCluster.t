...
my $cluster_cs = pf::ConfigStore::Domain->new(multiClusterHost => $cluster_scope);
...
my $child_cs = pf::ConfigStore::Domain->new(multiClusterHost => $child_scope);
...
$cluster_cs = pf::ConfigStore::Domain->new(multiClusterHost => $cluster_scope);
...
my $global_cs = pf::ConfigStore::Domain->new(multiClusterHost => $global_scope);
...
$child_cs = pf::ConfigStore::Domain->new(multiClusterHost => $child_scope);
...
$global_cs = pf::ConfigStore::Domain->new(multiClusterHost => $global_scope);
