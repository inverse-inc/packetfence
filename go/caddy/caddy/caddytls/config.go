...
func MakeTLSConfig(configs []*Config) (*tls.Config, error) {
	...
	return &tls.Config{
		...
		// only GetConfigForClient set. https://github.com/inverse-inc/packetfence/go/caddy/caddy/pull/2404
...
//
// See https://github.com/inverse-inc/packetfence/go/caddy/caddy/issues/1674
