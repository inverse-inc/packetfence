...
CoreDNS-007 has been [released](https://github.com/inverse-inc/packetfence/go/coredns/releases/tag/v007)!
...
* gRPC and TLS are made first class citizens. See [the zone
  specification](https://github.com/inverse-inc/packetfence/go/coredns/blob/master/README.md#zone-specification) on how
