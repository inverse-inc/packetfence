...
We are pleased to announce the [release](https://github.com/inverse-inc/packetfence/go/coredns/releases/tag/v1.0.2) of CoreDNS-1.0.2!
...
CoreDNS code, see the [pull request](https://github.com/inverse-inc/packetfence/go/coredns/pull/1315) for details.
