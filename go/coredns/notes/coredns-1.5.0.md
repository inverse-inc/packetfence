...
A new [release](https://github.com/inverse-inc/packetfence/go/coredns/releases/tag/v1.5.0): CoreDNS-1.5.0.
...
* [2593](https://github.com/inverse-inc/packetfence/go/coredns/issues/2593) seems to hone in on Docker and/or the
  container environment being a contributing factor.

* [2624](https://github.com/inverse-inc/packetfence/go/coredns/issues/2624) is because of TLS session negotiating in
  the *forward* plugin.
