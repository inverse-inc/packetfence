...
We are pleased to announce the [release](https://github.com/inverse-inc/packetfence/go/coredns/releases/tag/v1.1.1) of
CoreDNS-1.1.1!
...
for helping to debug the [scrubbing issue](https://github.com/inverse-inc/packetfence/go/coredns/issues/1625).
