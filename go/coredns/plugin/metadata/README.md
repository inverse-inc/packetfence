...
interface](https://godoc.org/github.com/inverse-inc/packetfence/go/coredns/plugin/metadata#Provider) will be called for
...
The [Provider interface](https://godoc.org/github.com/inverse-inc/packetfence/go/coredns/plugin/metadata#Provider) and
the [package level](https://godoc.org/github.com/inverse-inc/packetfence/go/coredns/plugin/metadata) documentation.
