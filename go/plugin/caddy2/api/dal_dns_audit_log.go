...
func (a *DnsAuditLog) List() http.HandlerFunc {
...
func (a *DnsAuditLog) Search() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewDnsAuditLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
...
func (a *DnsAuditLog) GetItem() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewDnsAuditLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
...
func (a *DnsAuditLog) DeleteItem() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewDnsAuditLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
...
func (a *DnsAuditLog) UpdateItem() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewDnsAuditLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
