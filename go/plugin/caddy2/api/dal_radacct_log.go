...
func (a *RadacctLog) List() http.HandlerFunc {
...
func (a *RadacctLog) Search() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewRadacctLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
...
func (a *RadacctLog) GetItem() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewRadacctLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
...
func (a *RadacctLog) DeleteItem() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewRadacctLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
...
func (a *RadacctLog) UpdateItem() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewRadacctLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
