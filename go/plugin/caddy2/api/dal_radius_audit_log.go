...
func (a *RadiusAuditLog) List() http.HandlerFunc {
...
func (a *RadiusAuditLog) Search() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewRadiusAuditLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
...
func (a *RadiusAuditLog) GetItem() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewRadiusAuditLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
...
func (a *RadiusAuditLog) DeleteItem() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewRadiusAuditLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
...
func (a *RadiusAuditLog) UpdateItem() http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		model := models.NewRadiusAuditLogModel(a.DBP, a.Ctx)
		var body RespBody
		var err error
...
func (a *RadiusAuditLog) AddToRouter(r *chi.Mux) {
