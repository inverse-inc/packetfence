...
var pathAdminRolesMap = []adminRoleMapping{
	...
	adminRoleMapping{prefix: apiPrefix + "/logs/", role: "SYSTEM"},
	adminRoleMapping{prefix: apiPrefix + "/eslogs/", role: "SYSTEM"},
	adminRoleMapping{prefix: apiPrefix + "/pftest/", role: "PFTEST"},
