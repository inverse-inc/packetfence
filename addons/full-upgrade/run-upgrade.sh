...
function handle_pkgnew_files() {
  ...
  # We handle this through configuration upgrade scripts
  rm -f /usr/local/pf/conf/authentication.conf.dpkg-dist
  rm -f /usr/local/pf/conf/authentication.conf.rpmnew
