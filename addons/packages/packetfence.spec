...
%config(noreplace)      /usr/local/pf/conf/adminroles.conf.example
%config(noreplace)      /usr/local/pf/conf/allowed-gaming-oui.txt
%config(noreplace)      /usr/local/pf/conf/allowed-gaming-oui.txt.example
%config(noreplace)      /usr/local/pf/conf/authentication.conf
%config(noreplace)      /usr/local/pf/conf/authentication.conf.example
...
%config(noreplace)      /usr/local/pf/conf/floating_network_device.conf.example
%config(noreplace)      /usr/local/pf/conf/guest-managers.conf
%config(noreplace)      /usr/local/pf/conf/guest-managers.conf.example
...
%config(noreplace)      /usr/local/pf/conf/log.conf.example
%dir                    /usr/local/pf/conf/nessus
%config(noreplace)      /usr/local/pf/conf/nessus/remotescan.nessus
%config(noreplace)      /usr/local/pf/conf/nessus/remotescan.nessus.example
%config(noreplace)      /usr/local/pf/conf/networks.conf
%config(noreplace)      /usr/local/pf/conf/networks.conf.example
...
%config(noreplace)      /usr/local/pf/conf/radiusd/eap.conf.example
%config(noreplace)	/usr/local/pf/conf/radiusd/radiusd.conf
%config(noreplace)      /usr/local/pf/conf/radiusd/radiusd.conf.example
%config(noreplace)	/usr/local/pf/conf/radiusd/sql.conf
%config(noreplace)      /usr/local/pf/conf/radiusd/sql.conf.example
%dir                    /usr/local/pf/conf/snort
%config(noreplace)      /usr/local/pf/conf/snort/classification.config
%config(noreplace)      /usr/local/pf/conf/snort/classification.config.example
%config(noreplace)      /usr/local/pf/conf/snort/local.rules
%config(noreplace)      /usr/local/pf/conf/snort/local.rules.example
%config(noreplace)      /usr/local/pf/conf/snort/reference.config
%config(noreplace)      /usr/local/pf/conf/snort/reference.config.example
%dir                    /usr/local/pf/conf/ssl
%config(noreplace)      /usr/local/pf/conf/switches.conf
%config(noreplace)      /usr/local/pf/conf/switches.conf.example
...
%config(noreplace)      /usr/local/pf/conf/httpd.conf.d/ssl-certificates.conf.example
%config(noreplace)      /usr/local/pf/conf/iptables.conf
%config(noreplace)      /usr/local/pf/conf/iptables.conf.example
%config(noreplace)      /usr/local/pf/conf/listener.msg
%config(noreplace)      /usr/local/pf/conf/listener.msg.example
%config(noreplace)      /usr/local/pf/conf/mdm.conf
%config(noreplace)      /usr/local/pf/conf/mdm.conf.example
%config(noreplace)      /usr/local/pf/conf/popup.msg
%config(noreplace)      /usr/local/pf/conf/popup.msg.example
%config(noreplace)      /usr/local/pf/conf/profiles.conf
%config(noreplace)      /usr/local/pf/conf/profiles.conf.example
%config(noreplace)      /usr/local/pf/conf/snmptrapd.conf
%config(noreplace)      /usr/local/pf/conf/snmptrapd.conf.example
%config(noreplace)      /usr/local/pf/conf/snort.conf
%config(noreplace)      /usr/local/pf/conf/snort.conf.example
%config(noreplace)      /usr/local/pf/conf/snort.conf.pre_snort-2.8
%config(noreplace)      /usr/local/pf/conf/snort.conf.pre_snort-2.8.example
%config(noreplace)      /usr/local/pf/conf/suricata.yaml
%config(noreplace)      /usr/local/pf/conf/suricata.yaml.example
...
%config(noreplace)      /usr/local/pf/conf/ui-global.conf.example
%dir                    /usr/local/pf/conf/users
%config(noreplace)      /usr/local/pf/conf/violations.conf
%config(noreplace)      /usr/local/pf/conf/violations.conf.example
...
%config(noreplace)      /usr/local/pf/html/captive-portal/captive_portal.conf.example
