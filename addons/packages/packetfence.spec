...
%{?el7:Requires: samba-winbind-clients, samba-winbind, collectd >= 5.6, collectd-mysql, collectd-apache, collectd-drbd, collectd-dns, collectd-iptables, collectd-openldap, collectd-redis}
%{?el6:Requires: collectd >= 5.6, collectd-apache, collectd-drbd, collectd-dns, collectd-iptables, collectd-openldap, collectd-redis}
%{?el6:Requires: node}
%{?el7:Requires: nodejs}
