...
* Local database passwords are now encrypted using bcrypt per default on all new installations. The old plaintext mode is still supported for legacy installations and to allow migration to the new mode.
