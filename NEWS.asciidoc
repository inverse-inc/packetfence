 ...
 * Remove Symantec Provisioner (#7700)
 * Remove OPSWAT Provisioner (#7716)
 * Remove httpd.proxy service (#7668)
 * Remove unused service httpd.collector (#7667)
 * Remove Traffic Shaping (#7666)
 * Optimize pfdhcp (#7710)
 * Allow the OS to pick the port instead doing retrying. (#7596)
 * ISO installer supports UEFI booting (#7724)
 * Update to go 1.20.5 (#7636)
 ...
 * Accurately display the number of registered nodes per role and the overall total of registered nodes. (ZEN 12.1 Odd maths problem on the status page graphics #7471)
 * Move freeradius refresh to pfqueue (#7620)
