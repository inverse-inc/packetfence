...
Version 4.0.6 released on 2013-MM-DD
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
* Allow change of owner in node editor
* Give then option for iptables not to be managed by iptables
...
* Fixed search by violation in advanced search of nodes
