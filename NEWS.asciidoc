...
* PacketFence pki service in golang
* Support Aruba switchs using Aruba OS 16.10
* Added service to correct broken Galera cluster members
* Added support for anomaly detection through Fingerbank
...
* Haproxy server the admin gui, httpd.admin disabled by default

Bug Fixes
+++++++++
* Fixed logic to move mac to another port (Avaya)
