...
* No longer need to repopulate password when updating LDAP Auth Sources
...
* Url redirection for external sites
* Fixed wrong template for device registrations
* fixed syntax error in sql upgrade script
* deauthenticateMac not respecting inheritance
* Remove a breaking dependency
