...
Version 6.1.0 released on xxxx-xx-xx
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

New Features
++++++++++++

* Added support for CoovaChilli capable hardware
...
* Moved radius audit log in it's own section
* Saved searches for the Radius Audit Logo
...
* Fix profile filter saving incorrectly on jessie
