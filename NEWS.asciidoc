...
* Use the same portal profile to validate the email code than you use to register your device

Bug Fixes
+++++++++

* Compute unregdate for autoreg 802.1x
* Fix portal profil uri filter in catalyst
