...
Version 6.4.0 released on xxxx-xx-xx
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
* Turned off HTTP Keep``Alive to avoid connections holding onto Apache processes (PR#1801)
...
* Condition Auto``Registration in RADIUS audit log is not working properly (#1812)
