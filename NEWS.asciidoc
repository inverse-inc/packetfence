 ...
 * Add ACL Precreate for individual and ALL switches (#7936)
 ...
 * Force mechanism LOGIN PLAIN for SMTP. (Unable to select SASL mechanism and timeout not honored #7813)
 ...
 * Add back missing thread support in radiusd (Undefined Subroutine $main::shared_clone (EAP TTLS/PAP and EntraID) #7963)
