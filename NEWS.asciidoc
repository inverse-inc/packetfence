 ...
 * Revamped the Web administration GUI (PR#2108)

Enhancements
++++++++++++

 * SNMP traps are now handled in pfqueue (PR#1656)
 * Added the ability to grant CLI write access for Extreme switches (PR#1699)
 ...
 * Reduce the number of ipset calls when adding ports for Active Directory (PR#1886)
 * pfmon tasks has their own configuration file (PR#1918)
 * new command pfcmd pfmon - for running pfmon task via pfcmd (PR#1918)
 ...
 * Added a new last_seen column to nodes to track their last activity (Authentication, HTTP portal, DHCP) (PR#1948)
 ...
 * Ability to manage multiple "active" endpoint behind a single switchport (PR#2034)
 * pfdhcplistner now run as a master-worker style service (PR#2036)
 * Adds a winbindd wrapper for the PacketFence managed winbindd processes (#2065/PR#2038/PR#2069)
 ...
 * Move common flows / process of dhcp processors in base class (PR#2086)
 ...
 * Tightening of HAproxy's SSL termination security (#893/#410/#411/#412/PR#2103)
 * Tightening of Apache's encryption security by requiring TLS v1.2 support only and restricted ciphersuites (#893/#410/#411/#412/PR#2103)
 * OCSP Stapling is proposed to clients through Apache (#893/#410/#411/#412/PR#2103)
 ...
 * Fix adding a UDP SRV record port as a TCP port (PR#1886)
 * Restores pf::api compatibility to Sourcefire module (#2048/PR#2019)
 ...
 * captive-portal: i18n label for dynamic fields (#1911)
