...
=== New Features
  ...
  - Support for NEC QX-S series switches (Comware 7): MAC authentication, 802.1X (including EAP-TLS), dynamic VLAN assignment, dynamic ACL assignment through Filter-Id (numbered ACL), VoIP (device-traffic-class=voice, tagged voice VLAN), RADIUS disconnect and CLI login. Validated on a QX-S4148GT-4G-PW running Comware 7.2.8
