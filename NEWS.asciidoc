...
=== New Features
  ...
  - Support for NEC QX-S series switches (Comware 7): MAC authentication, 802.1X, dynamic VLAN assignment, role assignment through Filter-Id, dynamic ACLs through H3C-Av-Pair, VoIP, RADIUS disconnect and CLI login
