...
Version 4.0.2 released on 2013-MM-DD
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
* Removed bind for pfdns
* Rewrite Oauth2 support (based on ipset session)
* New counters bellow line graphs of reports
* Support for anonymous bind in LDAP authentication sources
* Add support for date and time conditions in authentication sources
* Add "is not" condition on connection type
