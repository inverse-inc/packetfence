...
* Support for Single Sign-On integration with IBoss.
* Support for web authentication for NATed clients.
* Support for MAC Authentication and 802.1x to Alcatel switches.
* Support for the IBM StackSwitch G8052.
...
* Fix multiple xss vulnerabilities in the administration GUI.
