...
* Added support for Cambium AP module for 802.1x, MAC Auth and Web auth (PR #3282)
...
* Enable or disable Sponsor authentication when he validate access. (PR #2995) 

Enhancements
++++++++++++
* Allow profiles to be enabled/disabled (PR #3175)
...
* Allow Randomization of the search order for a list of servers
...
* Fixes when an authentication contain multiples ip addresses (#3234)
