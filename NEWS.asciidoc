...
New Features
++++++++++++
* LightSpeedRocket and SmoothWall firewall sso support
* Family Zone Firewall SSO support
...
* Added the radius's targeted IP address in the radius audit log (help in cluster mode)
* pfperl-api port number changed
