...
Version 6.3.0 released on xxxx-xx-xx
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

New Features
++++++++++++

* Support for OpenWRT Chaos Calmer 15.05 with Hostapd
* MySQL is now supported as the Fingerbank database backend
* Integration with Cisco MSE notifications in PacketFence
...
* Fingerbank is now configurable from the configurator
