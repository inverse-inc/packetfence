...
New Features
++++++++++++
* Replace the ISC DHCP server with a new Golang based DHCP server (PR #2911)
* Now supporting the Inline mode in active/active clusters (PR #2911)
...
* Traffic shaping support for inline setup (PR #2803)
* Added a configuration parameter to allow to unregister a device on an accounting stop (PR #2685)
* Adding CLI support on Aruba 5400 switches (PR #2965)
* Username stripping (removing the realm) is now configurable via the realms instead of the sources
* Add PacketFence integration with JAMF API for Apple computers and mobile devices management (PR #2797)

Enhancements
++++++++++++
* Distribute pfdhcplistener task among the cluster members (PR #2887) (#2858)Remove pfsetvlan
* Remove pfsetvlan
