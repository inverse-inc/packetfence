...
* Added support for Azure AD authentication (#6380)
* New Provisioner Google Workspace Chromebook
* LDAP Source now supports client certificates
* New Source for Google Workspace LDAP
...
* Added conditions on owner informations in the RADIUS filters (#6324)
* CLI Access Enabled for Avaya Switches (#6398)
...
* Backup DB using MariaDB-backup don't work on standalone installations (#6424)
